...
using ContentType = DNTCms.Common.Constants.ContentType;

namespace DNTCms.Web.Services.Feed
{
    /// <summary>
    ...
    public sealed class FeedService : IFeedService
    {
        ...
        public async Task<SyndicationFeed> GetFeed(CancellationToken cancellationToken)
        {
            var feed = new SyndicationFeed()
            {
                ...
                Title = SyndicationContent.CreatePlaintextContent("ASP.NET MVC "),
                ...
                Description = SyndicationContent.CreatePlaintextContent(
                    "This is the ASP.NET MVC  feed description."),
                ...
                Copyright = SyndicationContent.CreatePlaintextContent(
                    $"© {DateTime.Now.Year} - {Application.Name}"),
            ...
            feed.Links.Add(SyndicationLink.CreateSelfLink(
                new Uri(this._urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetFeed)),
                ContentType.Atom));
            ...
            feed.Links.Add(SyndicationLink.CreateAlternateLink(
                new Uri(this._urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetIndex)),
                ContentType.Html));
            ...
            feed.SetIcon(this._urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png"));
                ...
                new FormUrlEncodedContent(
                    new[]
                    {
                        ...
                        new KeyValuePair<string, string>(
                            "hub.url",
                            this._urlHelper.AbsoluteRouteUrl(""))
                    }));
        }
