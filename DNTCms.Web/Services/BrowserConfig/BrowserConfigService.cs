...
namespace DNTCms.Web.Services.BrowserConfig
{
    public class BrowserConfigService : IBrowserConfigService
    {
        ...
        public string GetBrowserConfigXml()
        {
            ...
            var square70X70LogoUrl = _urlHelper.Content("~/content/icons/mstile-70x70.png");
            // The URL to the 150x150 medium tile image.
            var square150X150LogoUrl = _urlHelper.Content("~/content/icons/mstile-150x150.png");
            // The URL to the 310x310 large tile image.
            var square310X310LogoUrl = _urlHelper.Content("~/content/icons/mstile-310x310.png");
            // The URL to the 310x150 wide tile image.
            var wide310X150LogoUrl = _urlHelper.Content("~/content/icons/mstile-310x150.png");
