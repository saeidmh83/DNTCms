...
namespace DNTCms.DataLayer.Context
{
    public interface IUnitOfWork
    {
        ...
        /// <param name="updateAuditFields"></param>
        /// <returns></returns>
        int SaveAllChanges(bool invalidateCacheDependencies = true, bool updateAuditFields = true);
        ...
        /// <param name="updateAuditFields"></param>
        /// <returns></returns>
        Task<int> SaveAllChangesAsync(bool invalidateCacheDependencies = true, bool updateAuditFields = true);
        /// <summary>
